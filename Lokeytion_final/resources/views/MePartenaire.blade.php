        ...
        <div class="box">
            ...
            <div class="basic-info">
                @php
                    ...
                    $integerPart = 0;
                    $decimalPart = 0;
                    if (isset($commentaires_pr)) {
                        foreach ($commentaires_pr  as $commentaire) {
            ...
            <div class="comments">
                <div class="inner">
                    ...
                    @if (isset($commentaires_pr ))
                        <h1>Commentaires en tant que partenaire</h1><a href="{{ route('UserProfil') }}"  >En tant que Client</a>
                        ...
                        @php
                            $count_pos = $commentaires_pr ->where('likes', 1)->count();
                            $count_neg = $commentaires_pr ->where('likes', 0)->count();
                            $count_comment = $commentaires_pr ->count();
