    ...
    <div class="col">
            <div class="form-item">
                ...
                <input type="text" name="titre" id="floatingInput"
                    class="input__field @error('titre') is-invalid @enderror" value="{{ old('titre') }}" required
                    style="width:80%">
                @error('titre')
        ...
        <div class="col">
            ...
            <div class="form-item">
                ...
                <select name="categorie" id="categorie" class="input__field @error('categorie') is-invalid @enderror"
                    ...
                    <option value="Sport" {{ old('categorie') == 'Sport' ? 'selected' : '' }}>Sport
                    </option>
                    <option value="articles_maison" {{ old('categorie') == 'articles_maison' ? 'selected' : '' }}>Articles maison</option>
                    <option value="vetements_accessoires" {{ old('categorie') == 'vetements_accessoires' ? 'selected' : '' }}>Vetements et Accessoires
                    </option>
                    <option value="instruments" {{ old('categorie') == 'instruments' ? 'selected' : '' }}>Instruments
                    </option>
                    <option value="livres_medias" {{ old('categorie') == 'livres_medias' ? 'selected' : '' }}>Livres et medias
                    </option>
                </select>
                @error('categorie')
                    <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea name="discription" id="discription" class="form-control my-3 @error('discription') is-invalid @enderror"
                            required rows="10" style="border: 1.5px solid #404040; width:110%">{{ old('discription') }}</textarea>
                        @error('discription')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
